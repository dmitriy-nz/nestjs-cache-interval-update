...
import {IntervalCacheUpdateConfig} from "../config/DefaultCache.config";
...
export class CacheIntervalUpdateService implements OnModuleInit {
    ...
    constructor(private metadataScanner: MetadataScanner,
                ...
                private cacheManagerConfig: IntervalCacheUpdateConfig) {

        if (!this.cacheManagerConfig.disable) {
